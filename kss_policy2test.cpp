...
#pragma omp parallel for                    
                    for(int k = 0; k < Nk; k++){
                        ...
                        if (Value_nd[currentadd_nd] < Value_d[currentadd_d])
                            std::cout << "default greater for ib " << ib << " iK is " << iK << " iy " << iy << " k is " << k << std::endl;
                        
						//std::cout << "nd is " << currentadd_nd << " " << Value_nd[currentadd_nd] << " " << Value_d[currentadd_d] << std::endl;
...
// 
// 						double cc = (1.0 + r)*k_grid[k] + pen;
// 
// 						std::cout << "c_d is " << c_d << " " << "c " << cc << std::endl;
