...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]){    
    //Needed Inputs 
    double *k_grid, *prob, *Z, *par, *b_grid, *vnd_init, *vd_init, *default_decision;
    ...
    default_decision = mxGetPr(prhs[7]);
    ...
    double *vo, *vo_temp, *vnd_temp, *kopt, *copt, *bopt, *price_mat;
